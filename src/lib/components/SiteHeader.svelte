<script lang="ts">
	...
	const navItems = [
		...
		{ href: '/publications', label: 'Publications', page: 'publications' },
...
<header class="site-header">
	<a class="brand" href="/" aria-label="{group.name} home" onclick={closeMenu}>
		<img class="brand-logo" src={group.logo} alt="" width="320" height="215" />
	</a>
